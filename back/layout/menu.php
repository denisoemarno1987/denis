<nav class="panel panel-header">
        ...
        <div class="panel-header col-md-2">
            ...
            <div class="container-fluid">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Menu-4 <span class="caret"></span><span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-wrench"></span></a>
                    <ul class="dropdown-menu forAnimate" role="menu">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Hai <b>Profile User</b> ! <span class="caret"></span><span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-info-sign"></span></a>
                    <ul class="dropdown-menu forAnimate" role="menu">
